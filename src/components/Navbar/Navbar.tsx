...
export const Navbar = () => {
  ...
  return (
    <Disclosure as="nav" className="border-b dark:border-gray-700">
      {({ open }) => (
        <>
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex-1 flex items-center justify-between sm:justify-start ">
                <a className="flex-shrink-0 flex items-center">
                  <div className="flex text-2xl text-left pl-2 pr-2">Movies & Series</div>
                </a>

                {/* Desktop menu items */}
                <div className="hidden sm:block sm:ml-6 border-l dark:border-gray-700">
                  <div className="flex">
                    {navigation.map((item) => (
                      <NavLink
